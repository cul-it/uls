...
class SmackUCIAdmin extends SmackUCIHelper {
	...
	public function get_mapping_widgets_order ($import_type) {
		//Added for group fields in mapping 
		$widgets = array();
		global $uci_admin;
		...
		switch ($import_type) {
			...
			case 'Users':
				$widgets = array('Core Fields','WordPress Custom Fields', 'Custom Fields by WP-Members', 'Custom Fields by Ultimate Member', 'Custom Fields by Members' , 'Billing And Shipping Information',
						'ACF Pro Fields', 'ACF Fields', 'ACF Repeater Fields','ACF Group Fields','Types Custom Fields', 'PODS Custom Fields', 'CCTM Custom Fields');
				break;
			case 'Comments':
				$widgets = array('Core Fields');
				break;
			...
			case 'eShop':
				$widgets = array('Core Fields', 'Product Meta Fields', 'WordPress Custom Fields', 'ACF Pro Fields',
						'ACF Fields', 'ACF Repeater Fields','ACF Group Fields','Types Custom Fields', 'PODS Custom Fields', 'CCTM Custom Fields',
			...
			case 'WooCommerceCategories' :
                 $widgets =array('Core Fields','ACF Pro Fields','ACF Fields','ACF Repeater Fields');
                  break;
			case 'MarketPressVariations':
				$widgets = array('Core Fields', 'Product Meta Fields');
				break;
			case 'Taxonomies':
				$widgets = array('Core Fields','ACF Pro Fields','ACF Fields', 'ACF Repeater Fields', 'ACF Group Fields','Yoast SEO Fields','Types Custom Fields');
				break;
			case 'Tags':
				$widgets = array('Core Fields', 'ACF Pro Fields','ACF Fields', 'ACF Repeater Fields', 'ACF Group Fields','Yoast SEO Fields');
				break;
			case 'Categories':
				$widgets = array('Core Fields','ACF Pro Fields','ACF Fields', 'ACF Repeater Fields', 'ACF Group Fields', 'Yoast SEO Fields');
				break;
			...
			foreach($active_plugins as $plugin) {
				switch ($plugin) {
					case 'advanced-custom-fields-pro/acf.php':
						...
						$possible_widgets['ACF Group Fields'] = 'GF'; //priya
						break;
	...
	public function get_widget_fields($widget_name, $import_type, $importAs, $mode = null) {
		...
		switch ($widget_name) {
			...
			case 'ACF Repeater Fields':
				...
				break;
			case 'ACF Group Fields':
				if(in_array('advanced-custom-fields-pro/acf.php', $this->get_active_plugins())) {
					$fields = $this->ACFProCustomFields($import_type, $importAs, $mode, 'GF');
				} 
				break;
